...
32.你做过的前端优化方案有哪些？
    ...
    1. 简单的如css放头部，js放底部
    2.css样式选择器不使用*选择器，尽量使用一个类名选择器，不嵌套类名；
...
37.基本垂直居中方案
    ...
    未知宽高的垂直居中
        ...
        使用一个空标签psan设置vertical-align基准线为中间，让其为inline-block;宽度为0;
